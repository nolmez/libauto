...
(function () {
    ...
    angular.module('BlurAdmin.pages.dashboard')
        .controller('PublishingHouseStatisticCtrl', PublishingHouseStatisticCtrl);

    /** @ngInject */
    function PublishingHouseStatisticCtrl($scope, $filter, baConfig, colorHelper, $http) {
        ...
        $http({
            method: 'GET',
            url: 'http://localhost:3000/api/publishing_house_based_book_counts/',
            headers: {
            ...
            receivedData = response.data.publishing_house_books;
            ...
            var ctx = document.getElementById('publishing-house-chart-area').getContext('2d');
            window.myDoughnut = new Chart(ctx, {
                type: 'doughnut',
                data: $scope.publishingHouseData,
                options: {
                    cutoutPercentage: 64,
                    responsive: true,
                    elements: {
